...
public class StockUp {
  ...
  public static void main(String[] args) {
    ...
    ink.printStartingFunds(); // moved starting balance print to ink class
    ...
    while(!isDone) {
      ...
      switch (choice) {
        ...
        double removeAmount = validator.fundValidation(ink, input, portfolio.getBalance());
        portfolio.withdrawFunds(removeAmount);
        // print the new balance
        System.out.printf("New balance: $%.2f\n", portfolio.getBalance());
        case 5:
          isDone = !isDone;
